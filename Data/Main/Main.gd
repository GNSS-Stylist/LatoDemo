...
@export var animResetTrigTest:bool:
	set(param):
		print("animResetTrigTest called", param)
		if (!animResetStashDone):
			stashToolData()
			animResetStashDone = true
		animResetTrigTest = param
	get:
		return animResetTrigTest
...
#		mainAnimationPlayer.current_animation = animChangeReq
		...
		# Init things not defined in this animation but used in others
		# so that they are kept in sync even when working with the editor
		...
		match(animChangeReq):
			"SatMorph":
				...
				$World/Planet.process_mode = Node.PROCESS_MODE_DISABLED
		
				$World/JellyPlanet.visible = false
				$World/JellyPlanet.process_mode = Node.PROCESS_MODE_DISABLED
				
				$World/LidarRig.visible = true
				$World/LidarRig.process_mode =Node.PROCESS_MODE_INHERIT
				
				$World/CameraRig.visible = false
				$World/CameraRig.process_mode =Node.PROCESS_MODE_DISABLED
				
				$World/AdditiveGeometries.visible = false
				$World/AdditiveGeometries.process_mode =Node.PROCESS_MODE_DISABLED
				
				$World/PlanetCore.visible = false
				$World/PlanetCore.process_mode =Node.PROCESS_MODE_DISABLED

				$World/LOScriptReplayer_MainBlackHole.visible = false
				$World/LOScriptReplayer_MainBlackHole.process_mode =Node.PROCESS_MODE_DISABLED
				
				$World/LidarLineSets.visible = false
				$World/LidarLineSets.process_mode =Node.PROCESS_MODE_DISABLED

				$World/LidarPointSets.visible = false
				$World/LidarPointSets.process_mode =Node.PROCESS_MODE_DISABLED
			...
			"Descent":
				...
				$World/JellyPlanet.visible = true
				$World/JellyPlanet.process_mode = Node.PROCESS_MODE_INHERIT
			...
			"Construction":
				...
				$World/CameraRig.process_mode =Node.PROCESS_MODE_INHERIT
				
				$World/AdditiveGeometries.visible = true
				$World/AdditiveGeometries.process_mode =Node.PROCESS_MODE_INHERIT
				...
				$World/LidarLineSets.visible = true
				$World/LidarLineSets.process_mode =Node.PROCESS_MODE_INHERIT

				$World/LidarPointSets.visible = true
				$World/LidarPointSets.process_mode =Node.PROCESS_MODE_INHERIT
			...
			"Destruction":
				...
				$World/Planet.visible = true
				$World/Planet.process_mode = Node.PROCESS_MODE_INHERIT
				...
				$World/PlanetCore.visible = false
				$World/PlanetCore.process_mode =Node.PROCESS_MODE_INHERIT

				$World/LOScriptReplayer_MainBlackHole.visible = true
				$World/LOScriptReplayer_MainBlackHole.process_mode =Node.PROCESS_MODE_INHERIT
			...
			"AscensionToGreatness":
				...
				$World/LidarRig.visible = false
				$World/LidarRig.process_mode =Node.PROCESS_MODE_DISABLED
